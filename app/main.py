...
def main():
    ...
    with col2:
        ...
        st.markdown("<p style='color: #6B7280; margin-top: -15px;'>Kiểm tra thông tin và trạng thái doanh nghiệp theo mã số thuế</p>", unsafe_allow_html=True)
    ...
    with tab1:
        ...
        st.markdown("<h3 style='color: #1E3A8A;'>Tra cứu theo Mã số thuế</h3>", unsafe_allow_html=True)
        st.markdown("<p class='info-box'>Nhập mã số thuế của doanh nghiệp cần tra cứu và nhấn nút Tra cứu</p>", unsafe_allow_html=True)
        ...
        with col2:
            search_button = st.button("Tra cứu", use_container_width=True)
    ...
    with tab2:
        st.markdown("<div class='card'>", unsafe_allow_html=True)
        st.markdown("<h3 style='color: #1E3A8A;'>Tra cứu hàng loạt</h3>", unsafe_allow_html=True)

        # Hướng dẫn với giao diện đẹp hơn
        st.markdown("<div class='info-box'>", unsafe_allow_html=True)
        st.markdown("<h4 style='margin-top: 0;'>Hướng dẫn sử dụng:</h4>", unsafe_allow_html=True)
        st.markdown("""
        <ol>
            <li>Tải file mẫu Excel bằng nút bên dưới</li>
            <li>Điền danh sách MST cần tra cứu vào file Excel</li>
            <li><b>Lưu ý:</b> Cột MST phải định dạng kiểu Text để giữ số 0 ở đầu</li>
            <li>Upload file đã điền và nhấn 'Tra cứu tất cả'</li>
        </ol>
